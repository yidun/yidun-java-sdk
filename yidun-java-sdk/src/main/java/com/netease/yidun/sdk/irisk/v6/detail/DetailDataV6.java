...
public class DetailDataV6 {
    ...
    public void setProtectionResult(String protectionResult) {
    ...
    public String getPhoneRiskType() {
        return phoneRiskType;
    }

    public void setPhoneRiskType(String phoneRiskType) {
        this.phoneRiskType = phoneRiskType;
    }

    public String getPhoneRiskLevel() {
        return phoneRiskLevel;
    }

    public void setPhoneRiskLevel(String phoneRiskLevel) {
        this.phoneRiskLevel = phoneRiskLevel;
    }

    public String getPhoneRiskScore() {
        return phoneRiskScore;
    }

    public void setPhoneRiskScore(String phoneRiskScore) {
    ...
    public void setIpRiskType(String ipRiskType) {
        this.ipRiskType = ipRiskType;
    }
