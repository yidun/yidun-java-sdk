...
public class IRiskCheckV6Test {
    ...
    private static final String sceneData = "testSceneData";
    ...
    public void iRiskCheckTest() {
        ...
        request.setSceneData(sceneData);

        request.timestamp(currentTimeMillis)
                .nonce(nonce)
                .protocol(ProtocolEnum.HTTP);

        IRiskCheckV6Response response = client.execute(request);
        assertEquals(200, response.getCode());

        IRiskCheckV6Result result = response.getData();
